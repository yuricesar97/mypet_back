...
public class PessoaJuridicaResource {
	...
	public ResponseEntity<List<PessoaJuridicaDTO>> findAll() {
		...
		List<PessoaJuridicaDTO> listDto = list.stream().map(obj -> new PessoaJuridicaDTO(obj))
	...
	public ResponseEntity<Page<PessoaJuridicaDTO>> findPage(
		...
		Page<PessoaJuridicaDTO> listDto = list.map(obj -> new PessoaJuridicaDTO(obj)); // stream percorre a lista, map
