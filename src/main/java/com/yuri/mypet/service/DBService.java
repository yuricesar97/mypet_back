...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		PessoaFisica cli1 = new PessoaFisica(null, "Maria Silva", "yuricesar97@gmail.com", "36378912377",
				...
				"Rua Flores", "300", "Apto 303", "Jardim", "38220834", "Arraras", null);
		cli1.getTelefones().addAll(Arrays.asList("27363323", "938393"));

		PessoaFisica cli2 = new PessoaFisica(null, "Ana Costa", "yur4544@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, bCryptPasswordEncoderEncoder.encode("321"), null, null, false, null,
				"Avenida Matos", "105", "Sala 800", "Centro", "38777012", "Ponte", null);
